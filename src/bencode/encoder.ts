import { IInfo, IMetainfoFile } from "../types/metainfo-file-structure.interface";
...
export class Encoder {
  ...
  private encodeDictionary(dictionary: { [k: string]: ParsedMagnetType; } | IMetainfoFile | IInfo): string {
